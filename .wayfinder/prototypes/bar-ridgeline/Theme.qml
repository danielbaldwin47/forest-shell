// Frozen slice of the design system spec (#8) — dark tokens verbatim from the
// board design brief §2, plus the type/motion decisions. Throwaway: the real
// shell gets `Core/Theme.qml` with a swappable palette (#12).
pragma Singleton
import QtQuick
